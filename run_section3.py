"""Run Section 3: Low NA Annular Aperture
...
print("="*70)
print(f"λ = {wavelength} μm, NA = 0.1, ε = 0.5, 0.99")
print()
...
print("="*70)
print(f"\nOutput directory: {sec3_dir}")

# Count files
total_files = 0
for subdir in sorted(os.listdir(sec3_dir)):
    subdir_path = f'{sec3_dir}/{subdir}'
