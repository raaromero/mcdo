"""Run Section 4: High NA Circular Aperture (ε=0)
...
- 1D profiles (Total Intensity, Ex, Ey, Ez) - symmetric r with Debye & Uniform comparisons for Gaussian
- 2D x-y (contour + heatmap) - physical units, z=0 focal plane
- 2D u-v (contour + heatmap) - optical units
- 2D r-z (contour + heatmap) - axial cross-section, symmetric r, portrait orientation

Parameters:
- λ = 532 nm
- NA = 0.9
- ε = 0 (circular aperture)
"""
...
print("="*70)
print(f"λ = {wavelength} μm, NA = 0.9, ε = 0 (circular)")
print()
...
print("="*70)
print(f"\nOutput directory: {sec4_dir}")

# Count files
total_files = 0
for subdir in os.listdir(sec4_dir):
    subdir_path = f'{sec4_dir}/{subdir}'
