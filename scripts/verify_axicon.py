...
fig.suptitle('Phase 4 — axicon conical pupil phase: focal segment with '
...
ax.set_xlim(0, 120)
ax.set_xlabel('u'); ax.set_ylabel('normalized on-axis intensity')
ax.set_title('(a) X_NA=0.8: axial segment vs β\n(dotted = θ* test points, β=20)',
             fontsize=10)
